  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center min-h-[400px] gap-10 md:gap-0 z-10">
          {/* Left: Text */}
          <div className="flex-1 flex flex-col justify-center items-start text-left py-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 leading-tight">Next-Gen Biometric</h1>
